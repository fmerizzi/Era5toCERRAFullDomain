...
train_generator = DataGeneratorMemmap("../tas_CERRA_3h_gr55_1985-2010.nc", "../tas_ERA5_3h_gr022_1985-2010.nc","t2m","t2m", 
                              max_cerra_tas_3h, max_era5_tas_3h, min_cerra_tas_3h, min_era5_tas_3h, inshape = 1072,sequential=False, batch_size=2, unet = True)

test_generator = DataGeneratorMemmap("../tas_CERRA_3h_gr55_2011-2020.nc", "../tas_ERA5_3h_gr022_2011-2020.nc","t2m","t2m", 
                              max_cerra_tas_3h, max_era5_tas_3h, min_cerra_tas_3h, min_era5_tas_3h, inshape = 1072,sequential=False, batch_size=2, unet = True)
...
if(training):
    ...
    model.load_weights(save_path+"/tas_unet_266.weights.h5")
    ...
    model.load_weights(save_path+"/tas_unet_340.weights.h5")
